...
```html
<form action="#">
  <!-- action attribute specifies where to send the form data when the form is submitted. In this case, it is set to "#" which means that the form will not be sent anywhere. -->
